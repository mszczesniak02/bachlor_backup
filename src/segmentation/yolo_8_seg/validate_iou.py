...
# current_dir = os.path.dirname(current_file_path)  # src/segmentation/yolo_8_seg
...
def get_prediction_mask(result, img_shape):
    ...
    # YOLOv8 masks are often smaller size, need to resize or use result.masks.xy (polygons)
...
def main():
    ...
    possible_models = [
        "/home/krzeslaav/Projects/bachlor/model_tests/FULL_DATASET/segmentation/yolo_big/runs/segment/yolov8m_crack_seg/weights/best.pt",  # Expected 'm' path
        # Existing 'n' path (fallback)
        "/home/krzeslaav/Projects/bachlor/model_tests/FULL_DATASET/segmentation/yolo_big/runs/segment/yolov8n_crack_seg/weights/best.pt",
                                          # Pretrained generic
    ]
    ...
    if model_path is None:
        print("Warning: Could not find trained model (checked for 'm' and 'n'). Using 'yolov8n-seg.pt' generic.")
